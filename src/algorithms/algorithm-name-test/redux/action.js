...
export const BUTTON_CLICK: string = "ALGORITHM_NAME_TEST_BUTTON_CLICK";
export const OPEN_MODAL_CLICK: string = "ALGORITHM_NAME_TEST_OPEN_MODAL_CLICK";
export const CLOSE_MODAL_CLICK: string =
  "ALGORITHM_NAME_TEST_CLOSE_MODAL_CLICK";
export const REFRESH_DATA_CLICK: string = "ALGORITHM_NAME_TEST_REFRESH_CLICK";
