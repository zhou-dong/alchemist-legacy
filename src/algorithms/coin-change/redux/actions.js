...
export const BUTTON_CLICK: string = "COIN_CHANGE_BUTTON_CLICK";
export const OPEN_MODAL_CLICK: string = "COIN_CHANGE_OPEN_MODAL_CLICK";
export const CLOSE_MODAL_CLICK: string = "COIN_CHANGE_CLOSE_MODAL_CLICK";
export const REFRESH_DATA_CLICK: string = "COIN_CHANGE_REFRESH_CLICK";
