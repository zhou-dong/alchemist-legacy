...
export const BUTTON_CLICK: string = "EXAMPLE_DP_BUTTON_CLICK";
export const OPEN_MODAL_CLICK: string = "EXAMPLE_DP_OPEN_MODAL_CLICK";
export const CLOSE_MODAL_CLICK: string = "EXAMPLE_DP_CLOSE_MODAL_CLICK";
export const REFRESH_DATA_CLICK: string = "EXAMPLE_DP_REFRESH_CLICK";
