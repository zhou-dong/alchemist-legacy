...
export const BUTTON_CLICK: string = "LONGEST_COMMON_SUBSEQUENCE_BUTTON_CLICK";
export const OPEN_MODAL_CLICK: string =
  "LONGEST_COMMON_SUBSEQUENCE_OPEN_MODAL_CLICK";
export const CLOSE_MODAL_CLICK: string =
  "LONGEST_COMMON_SUBSEQUENCE_CLOSE_MODAL_CLICK";
export const REFRESH_DATA_CLICK: string =
  "LONGEST_COMMON_SUBSEQUENCE_REFRESH_CLICK";
