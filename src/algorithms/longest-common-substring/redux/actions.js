...
export const BUTTON_CLICK: string = "LONGEST_COMMON_SUBSTRING_BUTTON_CLICK";
export const OPEN_MODAL_CLICK: string =
  "LONGEST_COMMON_SUBSTRING_OPEN_MODAL_CLICK";
export const CLOSE_MODAL_CLICK: string =
  "LONGEST_COMMON_SUBSTRING_CLOSE_MODAL_CLICK";
export const REFRESH_DATA_CLICK: string =
  "LONGEST_COMMON_SUBSTRING_REFRESH_CLICK";
