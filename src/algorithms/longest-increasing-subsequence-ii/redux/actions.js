...
export const BUTTON_CLICK: string =
  "LONGEST_INCREASING_SUBSEQUENCE_II_BUTTON_CLICK";
export const OPEN_MODAL_CLICK: string =
  "LONGEST_INCREASING_SUBSEQUENCE_II_OPEN_MODAL_CLICK";
export const CLOSE_MODAL_CLICK: string =
  "LONGEST_INCREASING_SUBSEQUENCE_II_CLOSE_MODAL_CLICK";
export const REFRESH_DATA_CLICK: string =
  "LONGEST_INCREASING_SUBSEQUENCE_II_REFRESH_CLICK";
