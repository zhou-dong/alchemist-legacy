...
export const BUTTON_CLICK: string = "MAXIMUM_SUBARRAY_PROBLEM_BUTTON_CLICK";
export const OPEN_MODAL_CLICK: string =
  "MAXIMUM_SUBARRAY_PROBLEM_OPEN_MODAL_CLICK";
export const CLOSE_MODAL_CLICK: string =
  "MAXIMUM_SUBARRAY_PROBLEM_CLOSE_MODAL_CLICK";
export const REFRESH_DATA_CLICK: string =
  "MAXIMUM_SUBARRAY_PROBLEM_REFRESH_CLICK";
